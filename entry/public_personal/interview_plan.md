...
2. Общие вопросы:
    ...
    - 3.3.2. _"Вы пишете новый функционал `AnimalGenomeGenerator`, в рамках которой вам надо реализовать сложную функцию `getFibonacciNumber()`. Вы обнаруживаете что где-то в другом месте проекта, в классе `GoldenRectanglePopup` уже реализована такая же функция. Как вы поступите?"_
